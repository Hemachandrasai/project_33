...
function setup() {
  ...
  blink.frameDelay = 20;
  eat.frameDelay = 20;
  bunny = createSprite(570,100,100,100);
   bunny.addImage(rabbit);
    bunny.scale = 0.2;
  higherground =new Ground(570,170,100,10);
  ...
  air_push = createImg('push1.png');
  air_push.position(90,90);
  air_push.size(200,200);
  air_push.mouseClicked(air);
